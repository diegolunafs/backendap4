...
import com.portfoliodl.DL.Security.Entity.UsuarioPrincipal;
...
public class JwtProvider {
    ...
    @Value("${jwt.secret}")  // El @Value permite traer los valores de jwt.secret y jwt.expiration de application.properties
